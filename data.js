...
{
    fs.appendFileSync('./UserData.csv',"username,followers,following,starred,orgs,repo_total,repo_name,repo_size,repo_stars\n");
    counter = 0;
    ...
    for(var k = 0; k < no_of_pages; k++)
    {
        ...
        for(var i = 0; i < per_page; i++)
        {
            ...
            {
                fs.appendFileSync('./UserData.csv',username+","+followers.data.length+","+following.data.length+","+
            ...
            {
                fs.appendFileSync('./UserData.csv',","+","+","+","+","+","+repos.data[j].name+","+repos.data[j].size+","+
